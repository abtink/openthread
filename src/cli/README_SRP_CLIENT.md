...
Enable/Disable auto start mode in SRP client. This command requires `OPENTHREAD_CONFIG_SRP_CLIENT_AUTO_START_API_ENABLE` feature to enabled.

Get current autostart mode
...
Indicates the state of SRP client, i.e., whether it is enabled/running or disabled.
